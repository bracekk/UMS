...
def init_db():
    ...
    alter_statements = [
        ...
        "ALTER TABLE orders ADD COLUMN materials_consumed INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE orders ADD COLUMN finished_stock_added INTEGER NOT NULL DEFAULT 0",
        ...
        "ALTER TABLE items ADD COLUMN reserved_quantity REAL NOT NULL DEFAULT 0",
        ...
        "ALTER TABLE purchase_requests ADD COLUMN order_id INTEGER",
